...
import type { RsshubConfig } from '../../types';
import { CustomExportDialog } from './IntegrationDialogs';
...
export function IntegrationsTab() {
  ...
  const currentRsshub = (): RsshubConfig => rsshub ?? { base_url: '', access_key: '' };
  ...
  const saveRsshub = (patch: Partial<RsshubConfig> = {}) => {
    update.mutate({
      kind: 'rsshub',
      rsshub: { ...currentRsshub(), base_url: baseUrl, access_key: accessKey, ...patch },
    });
  };
